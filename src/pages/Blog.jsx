  ...
  const defaultPosts = [
    {
      ...
      text: "Working on MERN Stack projects has taught me how impactful technology can be when applied to web development. Combining modern JavaScript technologies with real-world problems is my favorite way to innovate.",
    },
    {
      id: 2,
      title: "My Thoughts on MERN Stack Development",
      text: "I believe MERN Stack development should be a balance between functionality and emotion. Modern JavaScript technologies always inspire me to create something that feels personal and futuristic.",
    },
    {
      id: 3,
