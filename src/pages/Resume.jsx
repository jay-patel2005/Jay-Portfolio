      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margintop: 10, fontSize: 15, color: "#ccc" }}>
              1th Year MCA — MERN Stack | Gujarat Technological University, Ahmedabad
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              📍 Ahmedabad, Gujarat, India
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ jspatel.nvp@gmail.com | 📞 +91 7698359526
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              <strong>BCA</strong> —
              (Gujrat University), 2022–2025 <br />
              <span style={{ color: "#aaa" }}>GPA: 7.8</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>12th Board — Ultra-vision High School</strong> (Gujarat
              Board, 2022) <br />
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            ...
            <li>3️⃣ E-com Platform (In Progress)</li>
            <li>4️⃣ Recipy-finder </li>
          </ul>
        </motion.div>
        ...
        >
          {[
            ...
            { name: "💻 GitHub", link: "https://github.com/jay-patel2005" },
            { name: "💼 LinkedIn", link: "https://www.linkedin.com/in/jay-patel2005?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" },
          ].map((site) => (
            <motion.a
              key={site.name}
              href={site.link}
